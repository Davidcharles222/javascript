function verificar(){
    ...
    if (fano.value.length == 0 || Number(fano.value) > ano){// se valor do comprimento do ano for 0 ou valor do ano for maior que ano atual 
        ...
        img.setAttribute('id', 'foto')// setando o id foto na "div" criada 
        ...
        if (genero_masculino.checked){// se genero masculino estiver marcado
            ...
            if (idade >=0 && idade < 10){
                // Criança
                img.setAttribute('src', 'bebe-m.jpg')// seta a imagem do endereço 
            }else if(idade < 21){
                // Jovem
                img.setAttribute('src', 'jovem-m.jpg')// seta a imagem do endereço 
            }else if(idade < 50){
                // Adulto
                img.setAttribute('src', 'adulto-m.jpg')// seta a imagem do endereço 
            }else {
                // Idodo
                img.setAttribute('src', 'idoso-m.jpg')// seta a imagem do endereço 
            }
            ...
            if (idade >=0 && idade < 10){
                // Criança
                img.setAttribute('src', 'bebe-f.jpg')// seta a imagem do endereço 
            }else if(idade < 21){
                // Jovem
                img.setAttribute('src', 'jovem-f.jpg')// seta a imagem do endereço 
            }else if(idade < 50){
                // Adulto
                img.setAttribute('src', 'adulto-f.jpg')// seta a imagem do endereço 
            }else {
                // Idodo
                img.setAttribute('src', 'idoso-f.jpg')// seta a imagem do endereço 
            }
        }
